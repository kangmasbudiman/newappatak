...
class Uploadcasevac extends StatefulWidget {
  final int id;
  const Uploadcasevac({Key key, this.id}) : super(key: key);

  @override
  State<Uploadcasevac> createState() => _UploadcasevacState();
}

class _UploadcasevacState extends State<Uploadcasevac> {
  var vidiourl;
