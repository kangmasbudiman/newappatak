...
class Viewatm extends StatefulWidget {
  const Viewatm({Key key}) : super(key: key);

  @override
  State<Viewatm> createState() => _ViewatmState();
}

class _ViewatmState extends State<Viewatm> {
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => Viewatm()));
              },
            ),
          ],
        );
  ...
  getmarkerdarimysql() async {
    ...
    final response = await http.post(Uri.parse(RestApi.getatm),
