...
class Formcasevac extends StatefulWidget {
  const Formcasevac({Key key}) : super(key: key);

  @override
  State<Formcasevac> createState() => _FormcasevacState();
}

class _FormcasevacState extends State<Formcasevac> {
  ...
  save() async {
    ...
    request.fields['kategori'] = 2.toString();
