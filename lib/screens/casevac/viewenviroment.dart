...
class Viewenviroment extends StatefulWidget {
  const Viewenviroment({Key key}) : super(key: key);

  @override
  State<Viewenviroment> createState() => _ViewenviromentState();
}

class _ViewenviromentState extends State<Viewenviroment> {
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => Viewenviroment()));
              },
            ),
          ],
        );
  ...
  getmarkerdarimysql() async {
    ...
    final response = await http.post(Uri.parse(RestApi.getenviroment),
