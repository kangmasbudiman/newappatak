...
*/
  ...
  Listcasevacatm({this.id,this.jenispasien,this.keadaanlokasi,this.keterangan,this.latitude,this.levelurgency,this.lokasi,this.longitude,this.nama_lengkap,this.no_wa,this.pesan,this.tools,this.foto});

  factory Listcasevacatm.fromJson(Map<String, dynamic> json) {
    return new Listcasevacatm(
      id: json['id'],
      pesan: json['pesan'],
